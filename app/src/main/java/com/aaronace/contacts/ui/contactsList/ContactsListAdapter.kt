...
import com.aaronace.contacts.databinding.ListItemContactsBinding
...
//    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.addressImageButton.setOnClickListener {
            val gmmIntentUri =
                Uri.parse("geo:0,0?q="+currentContact.address.toString())
